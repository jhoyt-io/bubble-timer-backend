...
describe('WebSocket Handler', () => {
    ...
    describe('stopTimer', () => {
        describe('Given a stopTimer request with shared users', () => {
            test('Then it should remove shared relationships and delete timer', async () => {
                // Given
                const event = {
                    requestContext: {
                        connectionId: 'test-connection-id',
        ...
        describe('Given a stopTimer request with no shared users', () => {
            test('Then it should handle stopTimer with no shared users', async () => {
                // Given
                const event = {
                    requestContext: {
                        connectionId: 'test-connection-id',
        ...
        describe('Given a stopTimer request with database errors', () => {
            test('Then it should handle stopTimer errors gracefully', async () => {
                // Given
                const event = {
                    requestContext: {
                        connectionId: 'test-connection-id',
    ...
    describe('updateTimer', () => {
        describe('Given an updateTimer request with shared relationships', () => {
            test('Then it should update timer and manage shared relationships', async () => {
                // Given
                const event = {
                    requestContext: {
                        connectionId: 'test-connection-id',
